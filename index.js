...
const RPC_URL = "https://mainnet.helius-rpc.com/?api-key=63bedaab-1cb9-4dc0-a907-accf312519db"; // Quicknode or Helius give good rpc urls
const PRIVKEY = "47ZkV5GyAprYwqqjFkKsQsSXuj61aT75uexBjeVPUriUWMKcyKSds2V2V7jgFNBRwoU99De7JaHCL1m2pBtLdNdu"; // the private key of the account who will buy and sell, in base58 (phantom export for example)
const TOKEN_ADDR = "GV56mgQuzxRw4HtLQbRSsedNUBqYJKJxwiVEkeWzpump"; // Put the address of the token you want to bump here
